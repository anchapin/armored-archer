...
func run_tests() -> void:
	...
	await test_submit_combat_action_no_network()
	await test_get_match_state_no_network()
	await test_signal_emission()
	await test_update_local_state()
	await test_update_from_match_state_empty()
	await test_update_from_match_state_creator()
	await test_update_from_match_state_opponent()
	await test_utility_methods()
	await test_get_health_methods()
	await test_is_my_turn_sync()
	await test_submit_combat_action_invalid_params()
	await test_get_match_state_invalid_params()
	await test_turn_changed_signal()
	await test_combat_ended_signal()
