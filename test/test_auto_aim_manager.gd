...
func run_tests() -> void:
	...
	await test_register_enemy()
	await test_unregister_enemy()
	await test_get_best_target_no_enemies()
	await test_get_best_target_out_of_range()
	await test_get_best_target_out_of_angle()
	await test_get_best_target_valid()
	await test_get_best_target_closest_selected()
	await test_get_best_target_zero_direction()
	await test_get_target_position()
	await test_is_target_locked()
	await test_enemy_removal_invalid()
