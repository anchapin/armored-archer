...
# --- STITCHED GILDED QUEST PALETTE ---

const COLOR_SURFACE := Color("#fdffda")
const COLOR_SURFACE_CONTAINER := Color("#f6f3eb")
const COLOR_SURFACE_CONTAINER_LOW := Color("#fcf9f1")
const COLOR_SURFACE_CONTAINER_LOWEST := Color("#ffffff")
const COLOR_SURFACE_CONTAINER_HIGH := Color("#f0eee5")
const COLOR_SURFACE_CONTAINER_HIGHEST := Color("#ebe8df")
const COLOR_SURFACE_VARIANT := Color("#ebe8df")
const COLOR_SURFACE_BRIGHT := Color("#fdffda")
const COLOR_SURFACE_DIM := Color("#e5e2d9")
const COLOR_ON_SURFACE := Color("#383833")
const COLOR_OUTLINE_VARIANT := Color("#bbb9b3")
const COLOR_GHOST_BORDER := Color(0.733, 0.725, 0.702, 0.15)
const COLOR_AMBIENT_SHADOW := Color(0.22, 0.22, 0.2, 0.06)
const COLOR_GLASS_OVERLAY := Color(1, 1, 1, 0.8)
...
const COLOR_TERTIARY := Color("#00734e")
const COLOR_TERTIARY_CONTAINER := Color("#69f6b8")
const COLOR_TERTIARY_FIXED := Color("#69f6b8")
const COLOR_TERTIARY_DIM := Color("#006544")
const COLOR_ON_TERTIARY := Color("#ffffff")

const COLOR_GRADIENT_PRIMARY_START := Color("#0060ce")
const COLOR_GRADIENT_PRIMARY_END := Color("#6e9fff")

const COLOR_SURFACE_TINT := Color("#0060ce")
const COLOR_INVERSE_SURFACE := Color("#0e0e0b")
const COLOR_INVERSE_ON_SURFACE := Color("#9f9d97")
