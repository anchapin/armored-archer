...
@export var corner_radius: int = DesignTokens.RADIUS_MD
...
func _apply_panel_style() -> void:
	...
	if _is_dark_theme:
		bg_color = DesignTokens.COLOR_SURFACE_DARK
		border_color = DesignTokens.COLOR_BORDER_DARK
		shadow_color = Color.BLACK
	else:
		bg_color = DesignTokens.COLOR_SURFACE_LIGHT
		border_color = DesignTokens.COLOR_BORDER_LIGHT
		shadow_color = Color.BLACK
	...
	# Border
	style.border_width_left = DesignTokens.BORDER_WIDTH_SM
	style.border_width_top = DesignTokens.BORDER_WIDTH_SM
	style.border_width_right = DesignTokens.BORDER_WIDTH_SM
	style.border_width_bottom = DesignTokens.BORDER_WIDTH_SM
	style.border_color = border_color
	
	# Shadow
	if show_shadow:
		style.shadow_color = shadow_color
		style.shadow_size = DesignTokens.SHADOW_BLUR_MD
		style.shadow_offset = DesignTokens.SHADOW_OFFSET_MD
