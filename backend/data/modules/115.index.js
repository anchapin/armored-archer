...
try {
  ...
  const { Blob } = __webpack_require__(1158)
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __webpack_require__.e(/* import() */ 460).then(__webpack_require__.bind(__webpack_require__, 87460));
...
var external_node_url_ = __webpack_require__(50755);
