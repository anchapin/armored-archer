...
const nakama_1 = require("../../__mocks__/nakama");
const matchmaker_1 = require("../matchmaker");
const mockCtx = (0, nakama_1.createMockContext)();
const mockLogger = (0, nakama_1.createMockLogger)();
const mockNk = (0, nakama_1.createMockNakama)();
...
describe('rpcCreateMatch', () => {
    ...
    test('should create a match with target opponent', () => {
        ...
        const result = (0, matchmaker_1.rpcCreateMatch)(mockCtx, mockLogger, mockNk, payload);
