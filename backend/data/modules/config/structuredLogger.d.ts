 ...
 */
export declare function createRpcContext(options: {
    rpcName: string;
    userId?: string;
    requestId?: string;
    payload?: unknown;
 ...
 * @returns Structured metadata object
 */
export declare function createSystemEventContext(event: string, data?: Record<string, unknown>): LogContext;
/**
...
export declare class StructuredLogger {
     ...
     */
    constructor(runtimeLogger: Runtime.Logger, serviceName?: string, defaultContext?: LogContext, scrubber?: LogScrubber);
    /**
     ...
     */
    logRpcEntry(rpcName: string, userId: string, requestId: string, payload?: unknown): void;
    /**
     ...
     */
    logRpcExit(rpcName: string, userId: string, requestId: string, durationMs: number): void;
    /**
     ...
     */
    logRpcError(rpcName: string, userId: string, requestId: string, error: Error, durationMs: number): void;
    /**
     ...
     * @param data - Additional event data
     */
    logSystemEvent(level: LogLevel, event: string, data?: Record<string, unknown>): void;
    /**
     ...
     */
    logCacheOperation(operation: 'hit' | 'miss' | 'set' | 'delete' | 'clear', cacheName: string, key: string, metadata?: Record<string, unknown>): void;
    /**
     ...
     * @param metadata - Additional metadata
     */
    logDatabaseOperation(operation: 'read' | 'write' | 'delete' | 'list', collection: string, metadata?: Record<string, unknown>): void;
}
/**
 * Creates a new StructuredLogger instance.
 *
 ...
 */
export declare function createStructuredLogger(runtimeLogger: Runtime.Logger, serviceName?: string, defaultContext?: LogContext, scrubber?: LogScrubber): StructuredLogger;
