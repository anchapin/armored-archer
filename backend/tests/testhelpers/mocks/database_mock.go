...
// Source: backend/internal/database/database.go
//
// Generated by this command:
//
//	mockgen -source=backend/internal/database/database.go -destination=backend/tests/testhelpers/mocks/database_mock.go -package=mocks
//
...
func (mr *MockDatabaseMockRecorder) BeginTx(ctx, opts any) *gomock.Call {
