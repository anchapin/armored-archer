...
- [x] App Preview Video (optional) - N/A for initial release
...
|---------|--------|-------|
| in_app_purchases | ✅ Set | `true` (game has IAP for cosmetic items) |
| bundle_identifier | ✅ Set | `com.armoredarcher.game` |
| package_name | ✅ Set | `com.armoredarcher.game` |
