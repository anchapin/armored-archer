...
- **Schema Reference**: [backend/DATABASE_SCHEMA.md](backend/DATABASE_SCHEMA.md)
...
## Conventions
- Use ESM `import` syntax for TypeScript modules.
- Use `extends` syntax for GDScript modules.
- Require `*.test.ts` filename pattern for backend tests.
