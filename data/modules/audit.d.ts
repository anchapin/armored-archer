 ...
 */
export declare function logAudit(nk: Runtime.Nakama, userId: string, ipAddress: string | null, action: string, resource: string, details: Record<string, any>, result: 'success' | 'failure', error?: string): void;
