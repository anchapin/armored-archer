 ...
 * @param initializer - Nakama runtime initializer
 */
export declare function registerRpcGetCampaignProgress(initializer: Runtime.Initializer): void;
/**
 ...
 */
export declare function rpcGetCampaignProgress(ctx: Runtime.Context, logger: Runtime.Logger, nk: Runtime.Nakama, payload: string): string;
