...
var _receiptCleanupInterval = setInterval(cleanupOldReceipts, 60 * 60 * 1000);
...
function rpcAppLaunchCheck(ctx, logger, nk, payload) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var validation, pendingResultRaw, pendingResult, refundResultRaw, refundResult, subscriptionResultRaw, subscriptionResult;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    pendingResultRaw = _a.sent();
                    pendingResult = (0, safeParse_1.safeParse)(pendingResultRaw, null, logger, 'app_launch_check:pendingPurchases');
                    return [4 /*yield*/, rpcCheckRefunds(ctx, logger, nk, '{}')];
                case 2:
                    refundResultRaw = _a.sent();
                    refundResult = (0, safeParse_1.safeParse)(refundResultRaw, null, logger, 'app_launch_check:refunds');
                    return [4 /*yield*/, rpcCheckSubscriptions(ctx, logger, nk, '{}')];
                case 3:
                    subscriptionResultRaw = _a.sent();
                    subscriptionResult = (0, safeParse_1.safeParse)(subscriptionResultRaw, null, logger, 'app_launch_check:subscriptions');
                    return [2 /*return*/, JSON.stringify({
                            success: true,
