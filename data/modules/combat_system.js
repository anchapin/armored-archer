...
function validateMatchForCombat(nk, matchId, userId, span) {
    ...
    var matchResult = (0, safeParse_1.safeParse)(matchObjects[0].value, null, logger_1.logger, 'validateMatch:match');
...
function handleTurnTimeout(nk, matchState, logger) {
    ...
    if (matchState.consecutive_timeouts >= MAX_CONSECUTIVE_TIMEOUTS) {
        ...
        if (matchObjects.length > 0) {
            var matchResult = (0, safeParse_1.safeParse)(matchObjects[0].value, null, logger, 'handleTimeoutForfeit:match');
            if (matchResult.success && matchResult.data) {
...
function getOrCreateMatchState(nk, matchId, match, logger) {
    ...
    if (stateObjects.length > 0) {
        ...
        if (!stateObjects[0].value) {
            ...
            var stateResult = (0, safeParse_1.safeParse)(stateObjects[0].value, null, logger, 'getOrCreateMatchState');
...
function getPlayerStats(nk, userId, logger) {
    ...
    if (objects.length === 0) {
        ...
        var statsResult = (0, safeParse_1.safeParse)(objects[0].value, null, logger, 'getPlayerStats');
            ...
            return [2 /*return*/, (0, tracing_1.traceAsync)('rpc.player_disconnect', function (span) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        ...
                        return [2 /*return*/, (0, profiling_1.profileFunction)('combat.player_disconnect', function () {
                                ...
                                var matchResult = (0, safeParse_1.safeParse)(matchObjects[0].value, null, logger, 'rpcForfeitMatch:match');
                                if (!matchResult.success || !matchResult.data) {
                                ...
                                var stateResult = (0, safeParse_1.safeParse)(stateObjects[0].value, null, logger, 'rpcForfeitMatch:matchState');
                                if (!stateResult.success || !stateResult.data) {
                                    return JSON.stringify({ error: 'Failed to parse match state' });
                                }
                                var matchState = stateResult.data;
